...
const eventData = {
  ...
  calendarMonth: "10.2025",
};

const imageSrcs = [img1, img2, img3];
  ...
  return (
    <div className="details-page-container">
      ...
      <div className="event-details-bar">
        <div className="detail-item time-detail">{eventData.time}</div>
        ...
        <div className="detail-item year-detail">{eventData.year}</div>
      </div>

      {/* Widget Lịch */}
      <div className="calendar-widget">
        <div className="calendar-header">{eventData.calendarMonth}</div>
