...
import MiddlePhoto from "../assets/2.jpg";
...
const PhotoAlbumSection = ({ chapterTitle, firstQuote, secondQuote }) => {
  ...
  const defaultFirstQuote =
    "Em không phải là điểm cuối của tình yêu, mà là động lực nguyên sơ của nó. Vì em, anh đã yêu thế giới này.";
  const defaultSecondQuote =
    "Giữa thế gian huyền náo, em là điều duy nhất đáng giá.";
  ...
  return (
    <div className="album-section-container">
      ...
      <div className="album-quote-block middle-title-block">
        ...
        <p className="chapter-title script-font">
