...
const HeroSection = ({ groomName, brideName, quote }) => {
    ...
    // Dữ liệu mặc định
    const defaultQuote = "Hạnh phúc lớn nhất chính là có thể đặt tay mình vào tay em.";
        ...
        <div className="hero-section-container">
            ...
            <div className="hero-top-section">
                ...
                <div className="decoration-icons">
                    <div className="icon-set top-left">
                        <img src={Envelopes} alt="Lì xì" className="icon small custom-img" />
                    </div>
                    ...
                    <img src={WeddingDress} alt="Váy cưới" className="icon dress custom-img" />
                    
                    <div className="icon-set bottom-left">
                        <img src={Shoes} alt="Giày cưới" className="icon small custom-img" />
                    </div>
                    
                    <div className="icon-set bottom-right">
                        <img src={Bouquet} alt="Hoa cưới" className="icon small custom-img" />
                    </div>
                </div>

                {/* Trích dẫn */}
                <p className="hero-quote font-[Satisfy]">
                    {quote || defaultQuote}
                </p>
            </div>
            ...
            <div className="hero-bottom-section">
                ...
                <div className="names-section">
                    <span className="name-script groom font-[Satisfy]">{groomName || 'Tuấn'}</span>
                    <span className="name-separator">&</span>
                    <span className="name-script bride font-[Satisfy]">{brideName || 'Lương'}</span>
                </div>
